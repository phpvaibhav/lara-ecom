			...
			<form class="kt-form" action="@if(isset($category)) {{route('admin.category.update',$category->id)}} @else {{route('admin.category.store')}} @endif" method="post" accept-charset="utf-8">
				...
				<div class="kt-portlet__body">
					...
					<div class="form-group form-group-last">
						...
						<textarea name="description" class="form-control" data-provide="markdown" rows="10">@isset($category->description)  {!! $category->description !!}@endisset
							@if(isset($category->description))  {!! $category->description!!} @else {!!old('description')!!}  @endif
						</textarea>
